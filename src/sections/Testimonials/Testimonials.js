...
const Tdata = [
	{
		...
		color: '#242846',
		img: '../../assets/img/testimonials/haris-brackovic-thumb.jpg',
		url: 'haris-brackovic'
	},
	{
		id: 1,
		...
		color: '#ba9077',
		img: '../../assets/img/testimonials/anur-becirovic-thumb.jpg',
		url: 'anur-becirovic'
	},
	{
		id: 2,
		...
		color: '#1ABC9C',
		img: '../../assets/img/testimonials/faris-odobasic-thumb.jpg',
		url: 'faris-odobasic'
	},
	{
		id: 3,
		...
		color: '#C0392B',
		img: '../../assets/img/testimonials/amar-basic-thumb.jpg',
		url: 'amar-basic'
	},
	{
		id: 4,
		...
		color: '#513B56',
		img: '../../assets/img/testimonials/ilija-samarlic-thumb.jpg',
		url: 'ilija-samarlic'
	},
	{
		id: 5,
		...
		color: '#513B56',
		img: '../../assets/img/testimonials/amela-spahic-thumb.jpg',
		url: 'amela-spahic'
	},
	{
		id: 6,
		...
		color: '#513B56',
		img: '../../assets/img/testimonials/edin-congo-thumb.jpg',
		url: 'edin-congo'
	},
	{
		id: 7,
		...
		body:
			'Gigi School of Coding dramatically improved my knowledge of C# and SQL among other things, and gave me a chance to experience the real IT dynamic atmosphere everyone is buzzing about! A fantastic team of likeminded individuals in Mistral helped me realize I was on the right career path.</br></br> \n' +
			'During the internship, Gigi interns (now my dear friends and colleagues) were separated into teams of 3 or 4. Every two weeks we had to present our work (demo).</br></br> Maybe this sounds scary for some, like it was for me, but sooner or later everyone will be in that situation, so it is better to get rid of fear of public speaking by practising it from the very start.</br></br> All the projects at Gigi School of Coding were a real deal, so switching to a real Mistral project afterwards was pretty easy.\n' +
		...
		color: '#513B56',
		img: '../../assets/img/testimonials/merseda-spahic-thumb.jpg',
		url: 'merseda-spahic'
	}
];

export const Testimonials = props => (
	<div id="testimonials" class="testimonials my-6">
		<div class="testimonials__inner">
			<h3 class="g-title mb-5">GIGIJEVCI: THEIR STORY</h3>
			<div class="testimonials__wrapper gigi">
				{Tdata.map((item, index) => (
					<figure class="testimonial g-4">
						<img src={item.img} alt={item.header} />
						<figcaption>
							<h6>{item.header}</h6>
							<p>{getFirstNWords(item.body)} </p>
							<a href={`/testimonials/${item.url}`} class="link link--gigi" target="_blank">
								<span>Read More</span>
							</a>
						</figcaption>.
					</figure>
