...
export default class Headroom extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      state: 'unfixed',
      translateY: 0,
      className: 'header__top header__top--unfixed',
    };
  }
  ...
  unpin = () => {
    ...
    this.setState(
      {
        translateY: '-100%',
        className: 'header__top header__top--unpinned',
      },
      () => {
        setTimeout(() => {
  ...
  pin = () => {
    ...
    this.setState({
      translateY: 0,
      className: 'header__top header__top--pinned',
      state: 'pinned',
    });
  };
  ...
  render() {
    ...
    if (this.state.state !== 'unfixed') {
      ...
      className += ' header__top--scrolled';
    }
    ...
    const wrapperClassName = userClassName
      ? `${userClassName} gigi-header-wrapper`
      : 'gigi-header-wrapper';
